...
const projectData = [
    {
        ...
        approach: "I redesigned the data model by expanding the time horizon and engineering a robust dim date table. This included creating a custom month index to resolve chronological sorting issues in the Month-over-Month (MoM) Waterfall charts, preventing data from different years from overlapping. On the front end, I consolidated the fragmented visuals from those separate pages into one large, dynamic line chart controlled by interactive slicers. To provide deeper analytical context, I integrated statistical indicators, including trend lines and mean lines, directly into the visual.",
        key_outcomes: "The enhancement streamlined a rigid, multi-page reporting section into a highly interactive, centralized single-page view. The refined data modeling ensured accurate historical and MoM tracking, while the unified line chart and statistical indicators allowed stakeholders to instantly and sharply benchmark cross-platform performance. Because of its overall efficiency and visual clarity, this revamped view was officially adopted as the division's standard reporting format for routine performance tracking and business reviews." 
    },
    {
